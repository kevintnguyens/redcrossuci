...
(function ($) {
  ...
  Drupal.behaviors.groupMenuGroupswitch = {
    attach: function (context) {
      ...
      Drupal.groupMenu.originalParent = $('.menu-parent-select').val();
      Drupal.groupMenu.populateParentSelect();

      // Make sure the originalParent is set on page load.
      $('.menu-parent-select').val(Drupal.groupMenu.originalParent);
    }
  };
   ...
   */
  Drupal.groupMenu.populateParentSelect = function () {
