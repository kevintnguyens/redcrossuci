...
/**
 * @file
 * Hooks provided by the Group context module.
 */
 ...
 */
function hook_groupcontext_negotiation_info() {
  $providers = array();

  $providers['foo'] = array(
    'name' => t('Foo'),
    'description' => t("Determine context by checking if some foo value."),
    'callback' => 'foo_groupcontext_handler',
